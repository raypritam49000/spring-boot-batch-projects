...
public class BatchJobController {
    ...
    private final String TEMP_STORAGE = "/Users/pritamray/MyAllProgram/SpringBootBatchProjects/spring-batch-file-upload/src/main/resources/uploads/";
    ...
    public void startBatch(@RequestParam("file") MultipartFile multipartFile) {
        ...
        try {
            ...
            System.out.println("----- Code ------"+execution.getExitStatus().getExitCode());
